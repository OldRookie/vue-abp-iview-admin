...
const simplifycCnfigInfo = {
  result: {
    ...
    localization: {
      ...
      currentLanguage: { name: 'de', displayName: 'German', icon: 'famfamfam-flags de', isDefault: false, isDisabled: false, isRightToLeft: false },
      sources: [{ name: 'CoreVueApp', type: 'MultiTenantLocalizationSource' }],
      values: {
        CoreVueApp: {
          About: 'About',
          Actions: 'Actions',
...
export default {
  getConfiguration: config => {
    ...
    if (token) {
      return simplifycCnfigInfo;
    } else {
      var noAuthConfig = Object.assign({}, simplifycCnfigInfo);
